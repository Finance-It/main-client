...
function TabAdminComponent(props) {
        ...
        <Tabs defaultActiveKey="1">
         ...
         <h2>Proposal</h2>
          ...
          <h2>Debt Repayment</h2>
                ...
                key="3"
            >
                <Typography.Title level={4}>Transfer debt repayment to this account</Typography.Title>
                {props.campaign.virtual_acc_no && <DebtRepaymentComponent {...props} />}
                {!props.campaign.virtual_acc_no &&
                <Button type={'primary'} onClick={handleNewVirtualAcc}>Get Account Details</Button>}
            </TabPane>}
        </Tabs>
    </>
}
